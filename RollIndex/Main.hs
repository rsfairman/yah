...
This version avoids using a list for the five die values that make up a Roll,
and uses a single index instead. This produced a modest savings, but the
program still takes about four minutes to run single-threaded.
